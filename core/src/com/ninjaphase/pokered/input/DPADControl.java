 ...
 *
 */
class DPADControl extends Control {
     ...
     */
    DPADControl(TextureRegion texture, Vector2 position) {
        this.texture = texture;
        this.position = position;
        this.bounds = new Rectangle[]{
                new Rectangle(position.x+WHITE_SPACE, position.y+texture.getRegionHeight()-BUTTON_SPACE, BUTTON_SPACE, BUTTON_SPACE),
                ...
                new Rectangle(position.x+texture.getRegionWidth()-BUTTON_SPACE, position.y+WHITE_SPACE, BUTTON_SPACE, BUTTON_SPACE)
        };
