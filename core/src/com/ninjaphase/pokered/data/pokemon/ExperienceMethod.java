...
/**
 * <p>
 *     The {@code ExperienceMethod} contains experience methods which are used to calculate the experience.
 * </p>
 */
public final class ExperienceMethod {
    private static final int[] FAST_EXP_TABLE = new int[]{
    ...
    private static final int[] MEDIUM_FAST_EXP_TABLE = new int[]{
    ...
    private static final int[] MEDIUM_SLOW_EXP_TABLE = new int[]{
    ...
    private static final int[] SLOW_EXP_TABLE = new int[]{
    ...
    public static final ExperienceMethod FAST = new ExperienceMethod(FAST_EXP_TABLE),
                                         MEDIUM_FAST = new ExperienceMethod(MEDIUM_FAST_EXP_TABLE),
                                         MEDIUM_SLOW = new ExperienceMethod(MEDIUM_SLOW_EXP_TABLE),
                                         SLOW = new ExperienceMethod(SLOW_EXP_TABLE);

    private int[] table;

    /**
     * <p>
     *     Constructs a new {@code ExperienceMethod}.
     * </p>
     *
     * @param table The table.
     */
    private ExperienceMethod(int[] table) {
        this.table = table;
    }
     ...
     * </p>
     *
     * @param i The experience.
     * @return The experience for that level.
     */
    public int calculateExperienceForLevel(int i) {
